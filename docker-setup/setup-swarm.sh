...
Options:
  ...
  -w, --worker                                number of workers to create (default 1)
  -v, --version                               boot2docker github url (default version 1.13.0)
  -ds, --disksize                             hard disk size for docker-machine (default 4GB)
  -r, --memory                                memory ram size for docker-machine (default 1GB)"
  exit 1
}
